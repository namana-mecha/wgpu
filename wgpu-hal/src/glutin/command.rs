...
impl crate::CommandEncoder for CommandEncoder {
    ...
    unsafe fn copy_acceleration_structure_to_acceleration_structure(
        &mut self,
        src: &<Self::A as crate::Api>::AccelerationStructure,
        dst: &<Self::A as crate::Api>::AccelerationStructure,
        copy: wgt::AccelerationStructureCopy,
    ) {
        println!("CommandEncoder::copy_acceleration_structure_to_acceleration_structure(src: ?, dst: ?, copy: {:?})", copy);
        todo!()
    }
    ...
    unsafe fn draw_mesh_tasks(
        ...
        println!("CommandEncoder::draw_mesh_tasks(group_count_x: {:?}, group_count_y: {:?}, group_count_z: {:?})", group_count_x, group_count_y, group_count_z);
        todo!()
    }
    ...
    unsafe fn draw_mesh_tasks_indirect(
        ...
        println!(
            "CommandEncoder::draw_mesh_tasks_indirect(buffer: ?, offset: {:?}, draw_count: {:?})",
            offset, draw_count
        );
        todo!()
    }
    ...
    unsafe fn draw_mesh_tasks_indirect_count(
        ...
        println!("CommandEncoder::draw_mesh_tasks_indirect_count(buffer: ?, offset: {:?}, count_buffer: ?, count_offset: {:?}, max_count: {:?})", offset, count_offset, max_count);
        todo!()
    }
    ...
    unsafe fn read_acceleration_structure_compact_size(
        ...
        buf: &<Self::A as crate::Api>::Buffer,
    ) {
        println!("CommandEncoder::read_acceleration_structure_compact_size(acceleration_structure: ?, buf: ?)");
        todo!()
    }
}
